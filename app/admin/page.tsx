    ...
    <main className="min-h-screen p-8">
      <div className="mx-auto max-w-4xl space-y-4">
        <div className="flex items-center justify-between gap-4">
          ...
          <a className="rounded-lg border px-4 py-2 font-medium" href="/admin/courses/new">
            + Nowy kurs
          </a>
        </div>
              ...
              {courses.length === 0 ? (
                ...
                courses.map((c) => (
                  <tr key={c.id} className="border-b last:border-b-0">
                    ...
                    <td className="p-3">{c.is_published ? "Opublikowany" : "Szkic"}</td>
                  </tr>
                ))
              )}
            </tbody>
        ...
        <div className="flex gap-4 text-sm">
          <a className="underline" href="/admin">← Panel admina</a>
          <a className="underline" href="/logout">Wyloguj</a>
        </div>
      </div>
    </main>
  );
