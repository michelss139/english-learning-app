...
const TIPS = [
  "Jeśli podajesz konkretną datę — prawie zawsze będzie Past Simple.",
  "Pojawia się did? Czasownik wraca do formy podstawowej.",
  "Past Simple to czas opowiadania historii.",
];
